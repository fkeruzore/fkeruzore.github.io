...
#
# Takes a set of bibtex of publications and converts them for use with 
# [academicpages.github.io](academicpages.github.io). This is an interactive 
# Jupyter notebook
#
# The core python code is also in `pubsFromBibs.py`.
# Run either from the `markdown_generator` folder after replacing updating the
# publist dictionary with:
# * bib file names
...
add_scholar_links = False
n_auth_min = 5  # less than that many authors, we put the full list
n_auth_max = 3  # if we cut, we include that many authors
